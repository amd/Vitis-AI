...
DEPENDS += " \
    python3 python3-pip-native python3-setuptools-native \
    glib-2.0 glib-2.0-native xrt opencv jansson ne10 \
"
...
do_deploy() {
    install -d ${THISDIR}/files/wheels
    install -m 0644 ${WHEEL_DIR}/vart_x*.whl ${THISDIR}/files/wheels/
}
