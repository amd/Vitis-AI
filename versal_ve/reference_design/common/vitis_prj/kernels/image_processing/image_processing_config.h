...
#define HAS_RGB_YUV_FP32	0
#define HAS_R_G_B_FP32		0
#define HAS_B_G_R_FP32		0
#define HAS_BGR_FP32		0
#define HAS_Y_FP32		0
#define HAS_RGBX_YUVX_BF16	1
#define HAS_BGRX_BF16		1
#define HAS_Y_BF16		1
#define HAS_RGB_BF16		0
#define HAS_BGR_BF16		0
#define HAS_Y_FP16		0
#define HAS_RGB_FP16		0
#define HAS_BGR_FP16		0
#define HAS_RGBX_FP16		0
#define HAS_BGRX_FP16		0
#define HAS_R_G_B_FP16		0
#define HAS_R_G_B_BF16		0
#define HAS_B_G_R_FP16		0
#define HAS_B_G_R_BF16		0
