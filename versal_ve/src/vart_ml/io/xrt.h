...
extern "C"
{
	...
	/**
	 * @brief Wait for the end of inference (XRT) interrupt.
	 *
	 * @param handle Struct with connection information.
	 * @param ip_idx index of the IP being accessed.
	 * @return int The Vart ML error (vart_ml_error_id) code of the operation.
	...
	/**
	 * @brief Clean all remaining memory allocation and xrt object.
	 *
	 ...
	 *
	 * This function prints information about DDR and IP resources
	...
	/**
	 * @brief Return true if XRT was compiled in and is functional, false if using stub implementation.
	 */
	bool xrt_is_available(void);
