...
// llm_tokenizer::internal::narrow() is like gsl::narrow() but it is also available when exceptions are disabled.
...
// This implementation of llm_tokenizer::internal::narrow was copied and adapted from:
