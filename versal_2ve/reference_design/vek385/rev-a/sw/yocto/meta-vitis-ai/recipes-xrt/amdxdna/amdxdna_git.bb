...
S = "${WORKDIR}/git/drivers/accel/amdxdna"
...
#Driver version aux based XDNA. We need to update this manually when the XRT submodule is updated.
...
EXTRA_OEMAKE += "XDNA_BUS_TYPE=aux"

inherit module

MODULES_MODULE_SYMVERS_LOCATION = "build/drivers/accel/amdxdna"

do_install() {
    install -d ${D}${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra/
    install -m 0644 ${S}/build/drivers/accel/amdxdna/amdxdna.ko ${D}${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra/
}
MODULE_NAME = "amdxdna"
